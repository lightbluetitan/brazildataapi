...
#' Get Brazil's Hospital Beds (per 1,000 people) from World Bank
#'
#' @description
#' Retrieves Brazil's number of hospital beds per 1,000 people
...
#'
#' @export
get_brazil_hospital_beds <- function() {
  url <- "https://api.worldbank.org/v2/country/BRA/indicator/SH.MED.BEDS.ZS?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
