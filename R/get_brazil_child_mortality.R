...
#' Get Brazil's Under-5 Mortality Rate from World Bank
#'
#' @description
#' Retrieves Brazil's under-5 mortality rate, measured as the number of deaths
...
#'
#' @export
get_brazil_child_mortality <- function() {
  url <- "https://api.worldbank.org/v2/country/BRA/indicator/SH.DYN.MORT?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
