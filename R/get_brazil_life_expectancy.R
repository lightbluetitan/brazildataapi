...
#' Get Brazil's Life Expectancy at Birth (Total, Years) from World Bank
#'
#' @description
#' Retrieves Brazil's life expectancy at birth (total, years)
...
#'
#' @export
get_brazil_life_expectancy <- function() {
  url <- "https://api.worldbank.org/v2/country/BRA/indicator/SP.DYN.LE00.IN?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
