...
#' Get Brazil's Energy Use (kg of oil equivalent per capita) from World Bank
#'
#' @description
#' Retrieves Brazil's energy use per capita, measured in kilograms of oil equivalent,
...
#'
#' @export
get_brazil_energy_use <- function() {
  url <- "https://api.worldbank.org/v2/country/BRA/indicator/EG.USE.PCAP.KG.OE?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
