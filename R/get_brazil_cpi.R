...
#' Get Brazil's Consumer Price Index (2010 = 100) from World Bank
#'
#' @description
#' Retrieves Brazil's Consumer Price Index (CPI), with 2010 as the base year (index = 100),
...
#'
#' @export
get_brazil_cpi <- function() {
  url <- "https://api.worldbank.org/v2/country/BRA/indicator/FP.CPI.TOTL?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
