...
#' Get Brazil's Adult Literacy Rate
#'
#' @description
#' Retrieves Brazil's adult literacy rate (% of people ages 15 and above)
...
#' @examples
#' \donttest{
#'   literacy_data <- get_brazil_literacy_rate()
#'   head(literacy_data)
#' }
#'
...
#'
#' @export
get_brazil_literacy_rate <- function() {
  url <- "https://api.worldbank.org/v2/country/BRA/indicator/SE.ADT.LITR.ZS?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
