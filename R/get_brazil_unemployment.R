...
#' Get Brazil's Unemployment Rate (Total) from World Bank
#'
#' @description
#' Retrieves Brazil's total unemployment rate, measured as a percentage of the total labor force,
...
#'
#' @export
get_brazil_unemployment <- function() {
  url <- "https://api.worldbank.org/v2/country/BRA/indicator/SL.UEM.TOTL.ZS?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
