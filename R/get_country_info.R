...
#'
#' Retrieves selected, essential information about Brazil or any other country by its full name.
#' The data is retrieved from the REST Countries API.
#' See the API documentation at \url{https://restcountries.com/}.
#' Example API usage: \url{https://restcountries.com/v3.1/name/brazil?fullText=true}.
#'
...
#'
#' @param name Full country name (common or official). For example: "Brazil", "Peru", "France".
#'
